...
// Fungsi untuk memastikan DOM telah termuat sepenuhnya
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Event listener untuk proses konversi saat form disubmit
    form.addEventListener('submit', handleFormSubmit);
    
    // Event listener untuk tombol "Reverse"
    reverseButton.addEventListener('click', handleReverseClick);
    
    // Event listener untuk tombol reset (form reset)
    ...
    function handleFormSubmit(e) {
      ...
      if (isNaN(inputValue)) {
        // Jika suhu belum inputkan, tampilkan pesan error
    ...
    // Fungsi saat tombol "Reverse" diklik
    ...
    // Fungsi saat tombol "Reset" (form reset) diklik
